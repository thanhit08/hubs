...
export const ChatGPTContext = createContext<ChatContextValuesT>({ messageGroups: [], sendMessage: message => {} });
...
export function ChatContextProvider({ messageDispatch, children }: ChatContextProviderPropsT) {
  ...
  return (
    <ChatGPTContext.Provider value={{ messageGroups, unreadMessages, sendMessage, setMessagesRead }}>
      {children}
