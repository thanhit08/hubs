...
export function SpawnMessageGPTButton(props) {
  return (
...
export function SendMessageGPTButton(props) {
  return (
    <IconButton className={styles.chatInputIcon} {...props}>
      <SendIcon />
    </IconButton>
...
export const EmojiPickerGPTPopoverButton = React.memo(({ onSelectEmoji, disabled }) => {
...
EmojiPickerGPTPopoverButton.propTypes = {
  onSelectEmoji: PropTypes.func.isRequired,
  disabled: PropTypes.bool
};

EmojiPickerGPTPopoverButton.displayName = "EmojiPickerPopoverButton";

export function MessageGPTAttachmentButton(props) {
  return (
    <>
...
MessageGPTAttachmentButton.propTypes = {
  disabled: PropTypes.bool
};

export function ChatGPTLengthWarning({ messageLength, maxLength }) {
  return (
    <p
...
ChatGPTLengthWarning.propTypes = {
  messageLength: PropTypes.number,
  maxLength: PropTypes.number
};

export const ChatGPTInput = forwardRef(({ warning, isOverMaxLength, ...props }, ref) => {
  const intl = useIntl();
...
ChatGPTInput.displayName = "ChatInput";
...
export function SystemMessageGPT(props) {
  const intl = useIntl();
...
export function ChatGPTMessageGroup({ sent, sender, timestamp, messages }) {
  const intl = useIntl();
  return (
...
export function PermissionMessageGPTGroup({ sent, timestamp, messages }) {
  const intl = useIntl();
  return (
    <li className={classNames(styles.messageGroup, { [styles.sent]: sent })}>
      <p className={styles.messageGroupLabel}>
...
PermissionMessageGPTGroup.propTypes = {
  sent: PropTypes.bool,
  timestamp: PropTypes.any,
  messages: PropTypes.array
};

export const ChatGPTMessageList = forwardRef(({ children, ...rest }, ref) => (
  <ul {...rest} className={styles.messageList} ref={ref}>
    {children}
  </ul>
));

ChatGPTMessageList.propTypes = {
  children: PropTypes.node
};

ChatGPTMessageList.displayName = "ChatMessageList";
